class PuzzleState(object):
    ...
    def __init__(self, config, n, m, goal1, goal2, cost_function, parent=None, action="Initial", cost=0,
                 movement_cost=0, tile=0):
    ...
    def move_left(self):
        if self.blank_col == 0:
            ...
            return PuzzleState(tuple(new_config), self.n, self.m, self.goal1, self.goal2, self.cost_function,
                               parent=self,
                               action="Wrap_Left",
